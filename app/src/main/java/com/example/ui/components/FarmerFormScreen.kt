    ...
    Box(
        ...
        ExistingBookingsLookupSection(
            ...
            item(key = "section_crop_specification") {
                ...
                varietyLines.forEachIndexed { index, line ->
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .border(0.5.dp, if (isDark) Color.White.copy(alpha = 0.10f) else Color.Black.copy(alpha = 0.08f), RoundedCornerShape(12.dp))
                    ) {
                        Column(
                            ...
                            OutlinedTextField(
                                ...
                                onValueChange = { newName ->
                                    viewModel.updateVarietyLine(
                                        index,
                                        line.copy(variety = capitalizeWordsNaturally(newName))
                                    )
                                },
                ...
                Button(
                    onClick = { viewModel.addVarietyLine() },
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(44.dp)
                            ...
                            IconButton(
                                onClick = {
                                    showDatePicker(visitDate) {
                                        ...
                                        visitDateTFV = TextFieldValue(text = it, selection = TextRange(it.length))
                                    }
                                },
                ...
                Column(
                    ...
                    multiplePhoneNumbers!!.forEach { (number, typeLabel) ->
                        Surface(
                            ...
                            shape = RoundedCornerShape(12.dp),
                            color = Color.Transparent,
                            border = BorderStroke(1.dp, if (isDark) Color(0xFF373A45).copy(alpha = 0.6f) else Color(0xFFE0E0E0).copy(alpha = 0.8f)),
                            modifier = Modifier
                                .fillMaxWidth()
                                .clip(RoundedCornerShape(12.dp))
            ...
            Surface(
                ...
                Column(
                    ...
                    Surface(
                        shape = RoundedCornerShape(16.dp),
                        color = Color.Transparent,
                        border = BorderStroke(1.dp, if (isDark) Color(0xFF334155).copy(alpha = 0.6f) else Color(0xFFE0E0E0).copy(alpha = 0.8f)),
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(420.dp)
